...
Plans:
- [ ] 15-01-PLAN.md -- Info architecture + docs/README.md index (tone/citation/Mermaid contracts)
- [ ] 15-02-PLAN.md -- Extend example module (D-05): event emission, BullMQ job handler, Wave 0 tests
- [ ] 15-03-PLAN.md -- DOCS-01 Getting Started + DOCS-02 Architecture Overview (4 Mermaid diagrams)
...
| 15. Developer Documentation | v1.2 | 0/5 | Planned | - |

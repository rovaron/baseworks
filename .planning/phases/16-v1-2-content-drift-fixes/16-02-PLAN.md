...
BEFORE (the entire ```mermaid ... ``` fence starting at line 70 and its preceding one-sentence lead-in at line 68):
```
...
BEFORE (line 120, the bullet-list item describing the derive step):
```

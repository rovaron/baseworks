...
Reference full template: `C:/Projetos/baseworks/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projetos/baseworks/.claude/get-shit-done/templates/state.md`.

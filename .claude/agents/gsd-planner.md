...
@C:/Projetos/baseworks/.claude/get-shit-done/references/mandatory-initial-read.md
...
**Project skills:** @C:/Projetos/baseworks/.claude/get-shit-done/references/project-skills-discovery.md
...
@C:/Projetos/baseworks/.claude/get-shit-done/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/Projetos/baseworks/.claude/get-shit-done/references/planner-source-audit.md for constraint examples.

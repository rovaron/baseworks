...
<reference>
@C:/Projetos/baseworks/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Projetos/baseworks/.claude/get-shit-done/references/user-profiling.md` to load:

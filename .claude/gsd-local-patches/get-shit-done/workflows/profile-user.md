...
```bash
cp "C:/Projetos/baseworks/.claude/get-shit-done/USER-PROFILE.md" "C:/Projetos/baseworks/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="C:/Projetos/baseworks/.claude/USER-PROFILE.backup.md"
```

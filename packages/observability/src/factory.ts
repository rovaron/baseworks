 ...
 * on the ERROR_TRACKER env var. Defaults to "noop" when unset (D-03 / Phase
 * 17 only — Phase 18 changes the default to "pino").
 *
 * @returns The singleton ErrorTracker instance
 * @throws Error if ERROR_TRACKER is set to an unsupported value
 *
 * @example

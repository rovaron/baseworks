...
- Create named queues per module using hyphens, not colons (e.g., `billing-sync-subscription`, `email-send`) — BullMQ 5 forbids `:` in queue names (it is the Redis key separator)
